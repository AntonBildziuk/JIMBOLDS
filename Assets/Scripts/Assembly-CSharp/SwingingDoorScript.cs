...
public class SwingingDoorScript : MonoBehaviour
{
	...
	private void Update()
	{
        ...
        {
            outside.GetComponent<Animator>().SetTrigger("Closing");
            inside.GetComponent<Animator>().SetTrigger("Closing");
	...
	private void OnTriggerStay(Collider other)
	{
		if (!this.bDoorLocked)
		{
            ...
            {
                this.bDoorOpen = true;
                outside.GetComponent<Animator>().SetTrigger("Open");
                inside.GetComponent<Animator>().SetTrigger("Open");
                this.openTime += 2f;
            }
		}
	}
	...
	public void LockDoor(float time)
	{
		...
		this.bDoorLocked = true;
		this.lockTime = time;
        outside.GetComponent<Animator>().SetTrigger("Lock");
        inside.GetComponent<Animator>().SetTrigger("Lock");
    }
	...
	private void UnlockDoor()
	{
        ...
        outside.GetComponent<Animator>().SetTrigger("Closed");
        inside.GetComponent<Animator>().SetTrigger("Closed");
    }
