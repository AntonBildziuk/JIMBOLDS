...
public class MathGameScript : MonoBehaviour
{
    ...
    public void CheckAnswer()
    {
        ...
        else if (this.playerAnswer.text == "97" && !FunnyEasteregg || this.playerAnswer.text == "1997" && !FunnyEasteregg)
        {
            GameObject FunnyEaster = Instantiate(Funny, this.transform.position, this.transform.rotation);
            FunnyEasteregg = true;
        }
        if (this.problem <= 3)
        {
    ...
    public static bool FunnyEasteregg;
